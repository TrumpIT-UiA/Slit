...
<html lang="en">
	...
	<body>
					...
					<ul>
                        ...
                        <div class="dropdown">
                            ...
                            <div id="myDropdown" class="dropdown-content">
                                ...
                                <a href="#about">Moduler</a>
                                <a href="#contact">Progresjonsplan</a>
                            </div>
                        </div>
                        <script>
		...
		<!-- Main -->
			<section id="main" class="wrapper">
				<div class="container">
					...
					<header class="major">
                        <h2>Her kan du skifte profilbildet</h2>
						<div class="row">
								<section class="feature 6u 12u$(small)">
									<img class="image fit icon" src="../Static/images/user-3.png" alt="" />
			</section>
		</div>
					</header>
        ...
        <p>Endre Profilbilde her</p>
	<form action="ProfilePicture" method="post">
		<input type="file" value="Velg fil" name="fil">
